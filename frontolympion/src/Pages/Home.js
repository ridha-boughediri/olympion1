    ...
    <>
        ...
        <div class="row h-100 icon-row">
          <div class="col-6 my-auto icon-bloc-1">
            ...
            <div class="d-flex flex-row ">
              ...
              <div class="p-2 my-auto icon-text">
                Je choisi mon éco transport.
              </div>
            </div>
            <div class="d-flex flex-row ">
            ...
            <div class="d-flex flex-row ">
              ...
              <div class="p-2 my-auto icon-text">
                Je me connecte pour collecter mes Olympions.
              </div>
            </div>
            <div class="d-flex flex-row ">
              <div class="bi bi-coin icon p-2"></div>
              <div class="p-2 my-auto icon-text">
                Je convertis mes Olympions en cadeaux.
              </div>
            </div>
          </div>
      ...
      <div class="container icon-bloc">
        <div class="row h-100 icon-row-2">
          <div class="col-6 icon-bloc-3"></div>

          <div class="col-6 my-auto icon-bloc-4">
            <h1 class="h1-orange">Quels transports puis-je utiliser ?</h1>
            <div class="d-flex flex-row ">
              <p class="bloc-transport">
                Notre quotidien est fait de déplacements : pour aller et revenir
                du travail, rejoindre des amis, se rendre à la salle de sport,
                etc. Ce qui n’est pas sans conséquence sur notre santé et le
                changement climatique… Saviez-vous par exemple que les
                transports sont aujourd’hui responsables de 30% des émissions de
                gaz à effet de serre en France ? Heureusement, il existe des
                moyens de transport écologiques qui peuvent améliorer notre
                empreinte carbone. Passage en revue de ces modes de transport
                écoresponsables.{" "}
              </p>
            </div>
